...
# https://github.com/torongs82/Data/blob/master/TCGA/BRCA_exp.rda
load("BRCA_exp.rda")
...
```{r, eval = FALSE}
# https://github.com/torongs82/Data/blob/master/TCGA/LGG_GBM_exp.rda

load("LGG_GBM_exp.rda")
...
dataClin_LGG <- subset(dataClin_LGG,
                       select = c("submitter_id","vital_status", 
                                  "days_to_death", "days_to_last_follow_up"))

dataClin_GBM <- subset(dataClin_GBM,
                       select = c("submitter_id","vital_status", 
                                  "days_to_death", "days_to_last_follow_up"))
